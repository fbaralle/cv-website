...
const contacts = [
  {
    label: "fbaralle93@gmail.com",
    href: "mailto:fbaralle93@gmail.com",
    icon: (
  ...
  {
    label: "+54 3492 602125",
    href: "https://wa.me/543492602125",
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/francisco-baralle",
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/fbaralle",
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
